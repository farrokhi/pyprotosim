...
def create_Request():
    ...
    # Let's build Request 
    REQ_avps=[]
    REQ_avps.append(encodeAVP('Acct-Status-Type', '\x00\x00\x00\x02'))
    ...
    REQ_avps.append(encodeAVP('3GPP-Charging-Id', 123456789))
    REQ_avps.append(encodeAVP('3GPP-PDP-Type', 0))
    REQ_avps.append(encodeAVP('3GPP-CG-Address', '0.0.0.0'))
    REQ_avps.append(encodeAVP('3GPP-Selection-Mode', '0'))
    REQ_avps.append(encodeAVP('3GPP-Negotiated-DSCP', '\x00'))
    REQ_avps.append(encodeAVP('3GPP-GPRS-QoS-Profile', '05-13921F9396D5FE74800000006400'))
